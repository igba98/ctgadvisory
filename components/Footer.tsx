...
export default function Footer() {
  ...
  const footerLinks = {
    services: {
      title: "SERVICES",
      links: [
        { label: "Strategic Advisory", href: "/services/strategic" },
        ...
        { label: "Operational Excellence", href: "/services/operations" },
    ...
    company: {
      title: "COMPANY",
      links: [
        { label: "About CTG Advisory", href: "/about" },
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">CTG Advisory</span>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
              Leading strategic advisory services for modern businesses seeking
          ...
          {/* Services */}
          <div>
            <h4 className="font-semibold text-sm mb-4 text-secondary">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-sm text-white/60">
            <p>
              Copyright © {currentYear} CTG Advisory Inc. All rights reserved.
            </p>
