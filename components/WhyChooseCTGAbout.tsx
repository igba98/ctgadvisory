...
export default function WhyChooseCTGAbout() {
  const values = [
    {
      icon: (
        <svg
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 pt-4">
              {values.map((value, index) => (
                ...
                >
                  {/* Icon Container */}
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-white/10 group-hover:bg-secondary/30 flex items-center justify-center text-white group-hover:text-secondary transition-all duration-300">
                    {value.icon}
                  </div>
          ...
          <div className="relative">
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-secondary/30 rounded-full blur-3xl -z-10"></div>
